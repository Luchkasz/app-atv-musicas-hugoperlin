...
public class App extends BaseAppNavigator {
    ...
    private RepositorioPlaylists repositorioPlaylists = new RepositorioPlaylists(playlistDAO, artistaDAO, generoDAO);
    ...
    public void registrarTelas() {
        ...
        registraTela("CADASTRARPLAYLIST",
                new ScreenRegistryFXML(App.class,
                        ...
                        o -> new CadastroPlaylist(repositorioPlaylists, repositorioMusicas)));
                registraTela("LISTARPLAYLISTS",
                new ScreenRegistryFXML(App.class,
                        "listar_playlists.fxml",
                        o -> new ListarPlaylists(repositorioPlaylists)));
